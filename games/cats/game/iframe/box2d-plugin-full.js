...
goog.addDependency = function(o, t, e) {
    if (goog.DEPENDENCIES_ENABLED) {
        for (var i, n, s = o.replace(/\\/g, "/"), r = goog.dependencies_, b = 0; i = t[b]; b++)
            (r.nameToPath[i] = s)in r.pathToNames || (r.pathToNames[s] = {}),
            r.pathToNames[s][i] = !0;
        for (var a = 0; n = e[a]; a++)
...
goog.writeScripts_ = function() {
    ...
    for (var o in goog.included_)
        n.written[o] || s(o);
    for (var t = 0; t < e.length; t++) {
        if (!e[t])
            throw Error("Undefined script input");
        goog.importScript_(goog.basePath + e[t])
    }
}
,
...
goog.bindJs_ = function(t, e, o) {
    ...
    if (2 < arguments.length) {
        ...
        return function() {
            ...
            return Array.prototype.unshift.apply(o, i),
            t.apply(e, o)
        }
    }
    return function() {
...
goog.getCssName = function(o, t) {
    ...
    return e = goog.cssNameMapping_ ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? n : function(o) {
        for (var t = o.split("-"), e = [], i = 0; i < t.length; i++)
            e.push(n(t[i]));
        return e.join("-")
    }
    : function(o) {
...
goog.getMsg = function(o, e) {
    return e && (o = o.replace(/\{\$([^}]+)}/g, function(o, t) {
        return t in e ? e[t] : o
    })),
    o
}
...
,
goog.inherits = function(o, n) {
    function t() {}
    t.prototype = n.prototype,
    o.superClass_ = n.prototype,
    o.prototype = new t,
    (o.prototype.constructor = o).base = function(o, t, e) {
        var i = Array.prototype.slice.call(arguments, 2);
        return n.prototype[t].apply(o, i)
    }
}
,
...
goog.defineClass.createSealingConstructor_ = function(t, o) {
    if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
        ...
        var e = function() {
            ...
            return this.constructor === e && Object.seal(o),
            o
        };
        return e
    }
...
box2d.b2Simplex.prototype.GetSearchDirection = function(o) {
    ...
    case 2:
        ...
        return 0 < box2d.b2CrossVV(t, box2d.b2NegV(this.m_v1.w, box2d.b2Vec2.s_t0)) ? box2d.b2CrossOneV(t, o) : box2d.b2CrossVOne(t, o);
    default:
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    if (this.m_state = 0 < x ? box2d.b2LimitState.e_atUpperLimit : box2d.b2LimitState.e_inactiveLimit,
...
box2d.b2AABB.prototype.RayCast = function(o, t) {
    ...
    if (a < box2d.b2_epsilon) {
        ...
        var x = 1 / r
          , p = (this.lowerBound.x - n) * x
          , m = -1;
        if ((_ = (this.upperBound.x - n) * x) < p) {
            var h = p;
            p = _,
            _ = h,
            m = 1
    ...
    if (d < box2d.b2_epsilon) {
        ...
        var _;
        x = 1 / b,
        p = (this.lowerBound.y - s) * x,
        m = -1;
        if ((_ = (this.upperBound.y - s) * x) < p) {
            h = p;
            p = _,
            _ = h,
            m = 1
...
box2d.b2TimeOfImpact = function(o, t) {
    ...
    box2d.ENABLE_ASSERTS && box2d.b2Assert(l < d);
    var x = 0
      , p = 0
...
box2d.b2Contact.prototype.Update = function(o) {
    ...
    if (r) {
        ...
        e = 0 < this.m_manifold.pointCount;
...
box2d.b2PolygonShape.prototype.TestPoint = function(o, t) {
    for (var e = box2d.b2MulTXV(o, t, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), i = 0, n = this.m_count; i < n; ++i) {
        if (0 < box2d.b2DotVV(this.m_normals[i], box2d.b2SubVV(e, this.m_vertices[i], box2d.b2Vec2.s_t0)))
            return !1
    }
    return !0
}
...
box2d.b2PolygonShape.ComputeCentroid = function(o, t, e) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= t);
    var i = e;
    i.SetZero();
...
box2d.b2CollideEdgeAndCircle = function(o, t, e, i, n) {
    ...
    l <= 0) {
        ...
        if (x * x < box2d.b2DotVV(h, h))
            return;
        if (t.m_hasVertex0) {
            var _ = t.m_vertex0
              , c = r
              , y = box2d.b2SubVV(c, _, box2d.b2CollideEdgeAndCircle.s_e1);
            if (0 < box2d.b2DotVV(y, box2d.b2SubVV(c, s, box2d.b2Vec2.s_t0)))
                return
        }
    ...
    if (d <= 0) {
        ...
        if (t.m_hasVertex3) {
            ...
            if (0 < box2d.b2DotVV(f, box2d.b2SubVV(s, g, box2d.b2Vec2.s_t0)))
                return
        }
    ...
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < S),
...
box2d.b2EPCollider.prototype.Collide = function(o, t, e, i, n) {
    ...
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg())) : x ? (this.m_front = 0 <= d || 0 <= a && 0 <= l,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal0),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg())) : p ? (this.m_front = 0 <= l || 0 <= d && 0 <= a,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : (this.m_front = 0 <= d && 0 <= a && 0 <= l,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : s ? x ? (this.m_front = 0 <= d || 0 <= a,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal0)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1)),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_front = 0 <= d && 0 <= a,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : r ? p ? (this.m_front = 0 <= a || 0 <= l,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1))) : (this.m_front = 0 <= a && 0 <= l,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg()),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_front = 0 <= a,
    this.m_front ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1),
...
box2d.b2ChainShape.prototype.CreateChain = function(o, t) {
    if (t = t || o.length,
    box2d.ENABLE_ASSERTS && box2d.b2Assert(null === this.m_vertices && 0 === this.m_count),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(2 <= t),
    box2d.ENABLE_ASSERTS)
        for (var e = 1; e < t; ++e) {
            var i = o[e - 1]
              , n = o[e];
...
box2d.b2ChainShape.prototype.GetChildEdge = function(o, t) {
    ...
    o.m_hasVertex0 = 0 < t ? (o.m_vertex0.Copy(this.m_vertices[t - 1]),
    !0) : (o.m_vertex0.Copy(this.m_prevVertex),
    this.m_hasPrevVertex),
...
box2d.b2CollideCircles = function(o, t, e, i, n) {
    ...
    a * a < b || (o.type = box2d.b2ManifoldType.e_circles,
...
box2d.b2CollidePolygonAndCircle = function(o, t, e, i, n) {
    ...
    if (g <= 0) {
        ...
        if (d < (a = box2d.b2DotVV(box2d.b2SubVV(r, S, box2d.b2Vec2.s_t1), p[_])))
            return;
        o.pointCount = 1,
        o.type = box2d.b2ManifoldType.e_faceA,
...
box2d.b2ContactSolver.prototype.Initialize = function(o) {
    ...
    i = this.m_count; e < i; ++e)
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < c),
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    ...
    t = this.m_count; o < t; ++o) {
        ...
        if (1 === n.pointCount)
            ...
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= R.x && 0 <= R.y),
...
box2d.b2PositionSolverManifold.prototype.Initialize = function(o, t, e, i) {
    ...
    switch (box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < o.pointCount),
    o.type) {
    case box2d.b2ManifoldType.e_circles:
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function() {
    ...
    t = this.m_count; o < t; ++o) {
        ...
        i = m; e < i; ++e)
            ...
            V = 0 < (v = a + x + d * (A = box2d.b2CrossVV(M, u)) * A + p * (C = box2d.b2CrossVV(D, u)) * C) ? -S / v : 0,
            box2d.b2MulSV(V, u, J),
            h.SelfMulSub(a, J),
...
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function(o, t) {
    ...
    i = this.m_count; e < i; ++e) {
        ...
        s = x; n < s; ++n)
            ...
            w = 0 < (B = p + h + m * (v = box2d.b2CrossVV(J, f)) * v + _ * (V = box2d.b2CrossVV(T, f)) * V) ? -C / B : 0,
            box2d.b2MulSV(w, f, R),
            c.SelfMulSub(p, R),
...
box2d.b2ContactFilter.prototype.ShouldCollide = function(o, t) {
    var e = o.GetFilterData()
      , i = t.GetFilterData();
    return e.groupIndex === i.groupIndex && 0 !== e.groupIndex ? 0 < e.groupIndex : 0 != (e.maskBits & i.categoryBits) && 0 != (e.categoryBits & i.maskBits)
}
,
...
box2d.b2Island.prototype.Solve = function(o, t, e, i) {
    ...
    i) {
        ...
        for (r = 0; r < this.m_bodyCount; ++r) {
            (b = this.m_bodies[r]).GetType() !== box2d.b2BodyType.b2_staticBody && (v = 0 == (b.m_flags & box2d.b2BodyFlag.e_autoSleepFlag) || b.m_angularVelocity * b.m_angularVelocity > B || box2d.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > V ? b.m_sleepTime = 0 : (b.m_sleepTime += s,
            box2d.b2Min(v, b.m_sleepTime)))
        }
...
box2d.b2ContactFactory.prototype.AddType = function(t, o, e, i) {
    var n = box2d.b2MakeArray(256, function(o) {
        return t()
    })
      , s = function(o) {
        return 0 < n.length ? n.pop() : t(o)
    }
      , r = function(o, t) {
        n.push(o)
    };
...
box2d.b2ContactFactory.prototype.Create = function(o, t, e, i) {
    ...
    return null === a ? null : (b.primary ? (r = a(this.m_allocator)).Reset(o, t, e, i) : (r = a(this.m_allocator)).Reset(e, i, o, t),
    r)
}
,
box2d.b2ContactFactory.prototype.Destroy = function(o) {
    var t = o.m_fixtureA
      , e = o.m_fixtureB;
    0 < o.m_manifold.pointCount && !1 === t.IsSensor() && !1 === e.IsSensor() && (t.GetBody().SetAwake(!0),
...
box2d.b2DynamicTree.prototype.RayCast = function(o, t) {
    if (null !== this.m_root) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < n.GetLengthSquared()),
        n.Normalize();
        ...
        for (x.Push(this.m_root); 0 < x.GetCount(); ) {
            var p = x.Pop();
            if (null !== p && !1 !== box2d.b2TestOverlapAABB(p.aabb, a)) {
                var m = p.aabb.GetCenter()
                  , h = p.aabb.GetExtents();
                if (!(0 < box2d.b2Abs(box2d.b2DotVV(s, box2d.b2SubVV(e, m, box2d.b2Vec2.s_t0))) - box2d.b2DotVV(r, h)))
                    if (p.IsLeaf()) {
...
box2d.b2DynamicTree.prototype.MoveProxy = function(o, t, e) {
    ...
    o.aabb.Contains(t))
        return !1;
    this.RemoveLeaf(o);
    var i = box2d.b2_aabbExtension + box2d.b2_aabbMultiplier * (0 < e.x ? e.x : -e.x)
      , n = box2d.b2_aabbExtension + box2d.b2_aabbMultiplier * (0 < e.y ? e.y : -e.y);
...
box2d.b2DynamicTree.prototype.InsertLeaf = function(o) {
    ...
    this.m_root); !1 === n.IsLeaf(); ) {
        ...
        if (b = t.IsLeaf() ? (m.Combine2(i, t.aabb),
        m.GetPerimeter() + p) : (m.Combine2(i, t.aabb),
        a = t.aabb.GetPerimeter(),
        m.GetPerimeter() - a + p),
        d = e.IsLeaf() ? (m.Combine2(i, e.aabb),
        m.GetPerimeter() + p) : (m.Combine2(i, e.aabb),
...
box2d.b2DynamicTree.prototype.Balance = function(o) {
    ...
    if (1 < i) {
        ...
        return e.child1 = o,
        e.parent = o.parent,
        null !== (o.parent = e).parent ? e.parent.child1 === o ? e.parent.child1 = e : (box2d.ENABLE_ASSERTS && box2d.b2Assert(e.parent.child2 === o),
        e.parent.child2 = e) : this.m_root = e,
        n.height > s.height ? (e.child2 = n,
        ((o.child2 = s).parent = o).aabb.Combine2(t.aabb, s.aabb),
        e.aabb.Combine2(o.aabb, n.aabb),
        o.height = 1 + box2d.b2Max(t.height, s.height),
        e.height = 1 + box2d.b2Max(o.height, n.height)) : (e.child2 = s,
        ((o.child2 = n).parent = o).aabb.Combine2(t.aabb, n.aabb),
    ...
    if (i < -1) {
        ...
        return t.child1 = o,
        t.parent = o.parent,
        null !== (o.parent = t).parent ? t.parent.child1 === o ? t.parent.child1 = t : (box2d.ENABLE_ASSERTS && box2d.b2Assert(t.parent.child2 === o),
        t.parent.child2 = t) : this.m_root = t,
        r.height > b.height ? (t.child2 = r,
        ((o.child1 = b).parent = o).aabb.Combine2(e.aabb, b.aabb),
        t.aabb.Combine2(o.aabb, r.aabb),
        o.height = 1 + box2d.b2Max(e.height, b.height),
        t.height = 1 + box2d.b2Max(o.height, r.height)) : (t.child2 = b,
        ((o.child1 = r).parent = o).aabb.Combine2(e.aabb, r.aabb),
...
box2d.b2DynamicTree.prototype.GetAreaRatio = function() {
    ...
    var o = this.m_root.aabb.GetPerimeter()
      , e = function(o) {
        ...
        if (o.IsLeaf())
            return 0;
        var t = o.aabb.GetPerimeter();
        return t += e(o.child1),
        t += e(o.child2)
    };
    return e(this.m_root) / o
}
,
...
box2d.b2DynamicTree.prototype.ShiftOrigin = function(o) {
    var n = function(o, t) {
        if (null !== o && !(o.height <= 1)) {
            ...
            n(e, t),
            n(i, t),
            o.aabb.lowerBound.SelfSub(t),
            o.aabb.upperBound.SelfSub(t)
        }
    };
    n(this.m_root, o)
}
...
box2d.b2Body.prototype.SetLinearVelocity = function(o) {
    this.m_type !== box2d.b2BodyType.b2_staticBody && (0 < box2d.b2DotVV(o, o) && this.SetAwake(!0),
...
box2d.b2Body.prototype.SetMassData = function(o) {
    ...
    !0 !== this.m_world.IsLocked() && this.m_type === box2d.b2BodyType.b2_dynamicBody) {
        ...
        0 < o.I && 0 == (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) && (this.m_I = o.I - this.m_mass * box2d.b2DotVV(o.center, o.center),
...
box2d.b2Body.prototype.ResetMassData = function() {
    ...
    this.m_invMass = 1),
    0 < this.m_I && 0 == (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) ? (this.m_I -= this.m_mass * box2d.b2DotVV(o, o),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_I),
...
box2d.b2World.prototype.DestroyBody = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_bodyCount),
...
box2d.b2World.prototype.CreateJoint = function(o) {
    ...
    this.m_jointList = t,
    ++this.m_jointCount,
    (t.m_edgeA.joint = t).m_edgeA.other = t.m_bodyB,
    t.m_edgeA.prev = null,
    ...
    (t.m_edgeB.joint = t).m_edgeB.other = t.m_bodyA,
    t.m_edgeB.prev = null,
...
box2d.b2World.prototype.Solve = function(o) {
    ...
    for (var r = this.m_bodyCount, b = this.s_stack, a = this.m_bodyList; a; a = a.m_next)
        if (!(a.m_flags & box2d.b2BodyFlag.e_islandFlag) && !1 !== a.IsAwake() && !1 !== a.IsActive() && a.GetType() !== box2d.b2BodyType.b2_staticBody) {
            e.Clear();
            var d = 0;
            for ((b[d++] = a).m_flags |= box2d.b2BodyFlag.e_islandFlag; 0 < d; ) {
                i = b[--d];
                    ...
                    for (var l = i.m_contactList; l; l = l.next) {
                        ...
                        if (!(x.m_flags & box2d.b2ContactFlag.e_islandFlag) && (!1 !== x.IsEnabled() && !1 !== x.IsTouching())) {
                            ...
                            if (!p && !m)
                                ...
                                (b[d++] = _).m_flags |= box2d.b2BodyFlag.e_islandFlag)
                        }
                    }
...
box2d.b2World.prototype.Step = function(o, t, e) {
    ...
    this.m_stepComplete && 0 < n.dt) {
        s = new box2d.b2Timer;
        this.Solve(n),
        this.m_profile.solve = s.GetMilliseconds()
    }
    if (this.m_continuousPhysics && 0 < n.dt) {
        s = new box2d.b2Timer;
        this.SolveTOI(n),
...
,
box2d.b2World.prototype.QueryAABB = function(i, o) {
    var n = this.m_contactManager.m_broadPhase;
    n.Query(function(o) {
        var t = n.GetUserData(o);
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t instanceof box2d.b2FixtureProxy);
        var e = t.fixture;
        t.childIndex;
        return i instanceof box2d.b2QueryCallback ? i.ReportFixture(e) : i(e)
    }, o)
}
,
box2d.b2World.prototype.QueryShape = function(i, n, s) {
    var r = this.m_contactManager.m_broadPhase
      , o = box2d.b2World.prototype.QueryShape.s_aabb;
    n.ComputeAABB(o, s, 0),
    r.Query(function(o) {
        var t = r.GetUserData(o);
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t instanceof box2d.b2FixtureProxy);
        var e = t.fixture;
        t.childIndex;
        return !box2d.b2TestOverlapShape(n, 0, e.GetShape(), 0, s, e.GetBody().GetTransform()) || (i instanceof box2d.b2QueryCallback ? i.ReportFixture(e) : i(e))
    }, o)
}
,
box2d.b2World.prototype.QueryShape.s_aabb = new box2d.b2AABB,
box2d.b2World.prototype.QueryPoint = function(i, n) {
    var s = this.m_contactManager.m_broadPhase
      , o = box2d.b2World.prototype.QueryPoint.s_aabb;
    o.lowerBound.SetXY(n.x - box2d.b2_linearSlop, n.y - box2d.b2_linearSlop),
    o.upperBound.SetXY(n.x + box2d.b2_linearSlop, n.y + box2d.b2_linearSlop),
    s.Query(function(o) {
        var t = s.GetUserData(o);
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t instanceof box2d.b2FixtureProxy);
        var e = t.fixture;
        t.childIndex;
        return !e.TestPoint(n) || (i instanceof box2d.b2QueryCallback ? i.ReportFixture(e) : i(e))
    }, o)
}
,
box2d.b2World.prototype.QueryPoint.s_aabb = new box2d.b2AABB,
box2d.b2World.prototype.RayCast = function(a, d, l) {
    var x = this.m_contactManager.m_broadPhase
      , o = box2d.b2World.prototype.RayCast.s_input;
    o.maxFraction = 1,
    o.p1.Copy(d),
    o.p2.Copy(l),
    x.RayCast(function(o, t) {
        var e = x.GetUserData(t);
        ...
        if (i.RayCast(s, o, n)) {
            var r = s.fraction
              , b = box2d.b2World.prototype.RayCast.s_point;
            return b.SetXY((1 - r) * d.x + r * l.x, (1 - r) * d.y + r * l.y),
            a instanceof box2d.b2RayCastCallback ? a.ReportFixture(i, b, s.normal, r) : a(i, b, s.normal, r)
        }
...
box2d.b2World.prototype.RayCastOne = function(o, t) {
    var n = null
      , s = 1;
    return this.RayCast(function(o, t, e, i) {
        return i < s && (s = i,
        n = o),
        s
    }, o, t),
...
,
box2d.b2World.prototype.RayCastAll = function(o, t, n) {
    return n.length = 0,
    this.RayCast(function(o, t, e, i) {
        return n.push(o),
        1
    }, o, t),
    n
        ...
        if (o & box2d.b2DrawFlags.e_shapeBit)
            for (var e = this.m_bodyList; e; e = e.m_next) {
                ...
                for (var n = e.GetFixtureList(); n; n = n.m_next)
                    !1 === e.IsActive() ? t.SetRGB(.5, .5, .3) : e.GetType() === box2d.b2BodyType.b2_staticBody ? t.SetRGB(.5, .9, .5) : e.GetType() === box2d.b2BodyType.b2_kinematicBody ? t.SetRGB(.5, .5, .9) : !1 === e.IsAwake() ? t.SetRGB(.6, .6, .6) : t.SetRGB(.9, .7, .7),
                    this.DrawShape(n, t);
...
box2d.b2AreaJoint = function(o) {
    goog.base(this, o),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= o.bodies.length, "You cannot create an area joint with less than three bodies."),
    ...
    for (var e = this.m_targetArea = 0, i = this.m_bodies.length; e < i; ++e) {
...
box2d.b2BuoyancyController.prototype.Draw = function(o) {
    var t = new box2d.b2Vec2
      , e = new box2d.b2Vec2;
    t.x = this.normal.x * this.offset + 100 * this.normal.y,
    t.y = this.normal.y * this.offset - 100 * this.normal.x,
    e.x = this.normal.x * this.offset - 100 * this.normal.y,
    e.y = this.normal.y * this.offset + 100 * this.normal.x;
    var i = new box2d.b2Color(0,0,.8);
    o.DrawSegment(t, e, i)
}
,
...
box2d.b2TensorDampingController.prototype.SetAxisAligned = function(o, t) {
    ...
    this.T.ey.x = 0,
    this.T.ey.y = -t,
    this.maxTimestep = 0 < o || 0 < t ? 1 / box2d.b2Max(o, t) : 0
}
,
...
box2d.b2Rope.prototype.Initialize = function(o) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= o.count),
    this.m_count = o.count,
...
box2d.b2Rope.prototype.Step = function(o, t) {
    if (0 !== o) {
        for (var e = Math.exp(-o * this.m_damping), i = 0; i < this.m_count; ++i)
            ...
            0 < this.m_ims[i] && this.m_vs[i].SelfMulAdd(o, this.m_gravity),
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass)) : (this.m_motorMass = 0,
    this.m_motorImpulse = 0),
    o.step.warmStarting) {
        this.m_impulse *= o.step.dtRatio,
...
box2d.b2MotorJoint.prototype.SetMaxForce = function(o) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o) && 0 <= o),
    this.m_maxForce = o
}
,
...
Phaser.Physics.Box2D.prototype = {
    ...
    enable: function(o, t) {
        ...
        if (Array.isArray(o))
            for (e = o.length; e--; )
                ...
                t && o[e].hasOwnProperty("children") && 0 < o[e].children.length && this.enable(o[e], !0));
        else
            o instanceof Phaser.Group ? this.enable(o.children, t) : (this.enableBody(o),
            t && o.hasOwnProperty("children") && 0 < o.children.length && this.enable(o.children, !0))
    },
    ...
    clear: function() {
        var o = this.world.GetGravity().Clone();
        this.world = new box2d.b2World(o),
        this.world.SetDebugDraw(this.debugDraw),
        this.world.SetContactListener(this.contactListener),
        this._toRemove = []
    },
    ...
    convertTilemap: function(o, t, e, i) {
        ...
        for (var n = 0, s = 0, r = 0, b = 0, a = o.layers[t].height; b < a; b++)
            for (var d = n = 0, l = o.layers[t].width; d < l; d++) {
                var x = o.layers[t].data[b][d];
                if (x && -1 < x.index && x.collides)
                    if (i) {
...
Phaser.Physics.Box2D.renderBody = function(o, t, e, i) {
    ...
    var n = t.data
      , s = n.GetTransform()
      , r = t.world;
    s.p.x += -t.game.camera.x / r.ptmRatio,
    s.p.y -= -t.game.camera.y / r.ptmRatio,
    r.debugDraw.start(o),
    r.debugDraw.PushTransform(s);
    var b = Phaser.Color.webToColor(e)
      , a = r.debugDraw.color;
    a.r = b.r / 255,
    a.g = b.g / 255,
    a.b = b.b / 255;
    for (var d = n.GetFixtureList(); d; d = d.GetNext())
        r.world.DrawShape(d, a);
    r.debugDraw.PopTransform(),
    r.debugDraw.stop()
}
,
...
Phaser.Physics.Box2D.Body.prototype = {
    setBodyContactCallback: function(o, t, e) {
        ...
        -1 < i && (null === t ? (delete this._bodyContactCallbacks[i],
    ...
    setFixtureContactCallback: function(o, t, e) {
        var i = o.id;
        -1 < i && (null === t ? (delete this._fixtureContactCallbacks[i],
    ...
    setCategoryContactCallback: function(o, t, e) {
        ...
        delete this._categoryContactCallbacksContext[o]) : (this._categoryContactCallbacks[o] = t,
        this._categoryContactCallbackContext[o] = e)
    },
    setBodyPresolveCallback: function(o, t, e) {
        var i = -1;
        o.id ? i = o.id : o.body && (i = o.body.id),
        -1 < i && (null === t ? (delete this._bodyPresolveCallbacks[i],
    ...
    setFixturePresolveCallback: function(o, t, e) {
        var i = o.id;
        -1 < i && (null === t ? (delete this._fixturePresolveCallbacks[i],
    ...
    setCategoryPresolveCallback: function(o, t, e) {
        ...
        delete this._categoryPresolveCallbacksContext[o]) : (this._categoryPresolveCallbacks[o] = t,
        this._categoryPresolveCallbackContext[o] = e)
    },
    setBodyPostsolveCallback: function(o, t, e) {
        var i = -1;
        o.id ? i = o.id : o.body && (i = o.body.id),
        -1 < i && (null === t ? (delete this._bodyPostsolveCallbacks[i],
    ...
    setFixturePostsolveCallback: function(o, t, e) {
        var i = o.id;
        -1 < i && (null === t ? (delete this._fixturePostsolveCallbacks[i],
...
Phaser.Physics.Box2D.DefaultContactListener.prototype.handleContactBeginOrEnd = function(o, t) {
    ...
    if (void 0 !== a && void 0 !== d) {
        ...
        a._fixtureContactCallbacks[e.id] && a._fixtureContactCallbacks[e.id].call(a._fixtureContactCallbackContext[e.id], a, d, e, i, t, o),
        d._fixtureContactCallbacks[i.id] && d._fixtureContactCallbacks[i.id].call(d._fixtureContactCallbackContext[i.id], d, a, i, e, t, o),
        ...
        a._categoryContactCallbacks[r] && a._categoryContactCallbacks[r].call(a._categoryContactCallbackContext[r], a, d, e, i, t, o),
        d._categoryContactCallbacks[b] && d._categoryContactCallbacks[b].call(d._categoryContactCallbackContext[b], d, a, i, e, t, o)
    }
}
,
...
Phaser.Physics.Box2D.Polygon.prototype.left = function(o, t, e) {
    return 0 < this.areaInTriangle(o, t, e)
}
,
...
Phaser.Physics.Box2D.Polygon.prototype.isConvex = function() {
    for (var o = !1, t = !1, e = 0, i = this.vertices.length; e < i; e++) {
        var n = e
          , s = (e + 1) % i
          , r = (e + 2) % i;
        0 < this.areaInTriangle(this.vertices[n], this.vertices[s], this.vertices[r]) ? o = !0 : t = !0
    }
    return t ^ o
}
,
...
Phaser.Physics.Box2D.Polygon.prototype.decompose = function(o) {
    ...
    if (!s && 8 < this.vertices.length && (t = 0,
