            ...
            for (var joy = 0; joy < GLFW.lastGamepadState.length; ++joy) {
                ...
                if (gamepad) {
                    if (!GLFW.joys[joy] || GLFW.joys[joy].id_string != gamepad.id) {
                        ...
                        GLFW.joys[joy] = { id: allocate(intArrayFromString(gamepad.id), "i8", ALLOC_NORMAL), id_string: gamepad.id, axesCount: gamepad.axes.length, buttonsCount: gamepad.buttons.length };
                        if (GLFW.gamepadFunc) {
...
function _glfwOpenWindow(width, height, redbits, greenbits, bluebits, alphabits, depthbits, stencilbits, mode) {
    ...
    var contextAttributes = { antialias: GLFW.params[131091] > 1, depth: GLFW.params[131081] > 0, stencil: GLFW.params[131082] > 0 };
...
var asmLibraryArg = {
    Bf: _PokiSdkJs_CommercialBreak,
    Af: _PokiSdkJs_GameplayStart,
    zf: _PokiSdkJs_GameplayStop,
    yf: _PokiSdkJs_HappyTime,
    xf: _PokiSdkJs_IsAdBlock,
    wf: _PokiSdkJs_RewardedBreak,
    vf: _PokiSdkJs_SetDebug,
    b: ___assert_fail,
    uf: ___clock_gettime,
    tf: ___gmtime_r,
    sf: ___localtime_r,
    qf: ___sys__newselect,
    gf: ___sys_dup2,
    mf: ___sys_dup3,
    i: ___sys_fcntl64,
    hf: ___sys_ioctl,
    ...
    cf: _clock,
    bf: _difftime,
    af: _dmDeviceJSFreeBufferSlots,
    $e: _dmDeviceJSOpen,
    _e: _dmDeviceJSQueue,
    Ze: _dmGetDeviceSampleRate,
    Ye: _dmResZipRequestFileAsync,
    Xe: _dmScriptHttpRequestAsync,
    We: _dmSysGetApplicationPath,
    Ve: _dmSysGetUserAgent,
    Ue: _dmSysGetUserPersistentDataRoot,
    Te: _dmSysGetUserPreferredLanguage,
    Se: _dmSysOpenURL,
    Re: _emscripten_asm_const_int,
    Qe: _emscripten_cancel_main_loop,
    ...
    He: _emscripten_glBindVertexArrayOES,
    ...
    Be: _emscripten_glBufferData,
    Ae: _emscripten_glBufferSubData,
    ze: _emscripten_glCheckFramebufferStatus,
    ye: _emscripten_glClear,
    xe: _emscripten_glClearColor,
    we: _emscripten_glClearDepthf,
    ve: _emscripten_glClearStencil,
    ue: _emscripten_glColorMask,
    te: _emscripten_glCompileShader,
    se: _emscripten_glCompressedTexImage2D,
    re: _emscripten_glCompressedTexSubImage2D,
    qe: _emscripten_glCopyTexImage2D,
    pe: _emscripten_glCopyTexSubImage2D,
    oe: _emscripten_glCreateProgram,
    ne: _emscripten_glCreateShader,
    me: _emscripten_glCullFace,
    le: _emscripten_glDeleteBuffers,
    ke: _emscripten_glDeleteFramebuffers,
    je: _emscripten_glDeleteProgram,
    ie: _emscripten_glDeleteQueriesEXT,
    he: _emscripten_glDeleteRenderbuffers,
    ge: _emscripten_glDeleteShader,
    fe: _emscripten_glDeleteTextures,
    ee: _emscripten_glDeleteVertexArraysOES,
    de: _emscripten_glDepthFunc,
    ce: _emscripten_glDepthMask,
    be: _emscripten_glDepthRangef,
    ae: _emscripten_glDetachShader,
    $d: _emscripten_glDisable,
    _d: _emscripten_glDisableVertexAttribArray,
    Zd: _emscripten_glDrawArrays,
    Yd: _emscripten_glDrawArraysInstancedANGLE,
    Xd: _emscripten_glDrawBuffersWEBGL,
    Wd: _emscripten_glDrawElements,
    Vd: _emscripten_glDrawElementsInstancedANGLE,
    Ud: _emscripten_glEnable,
    Td: _emscripten_glEnableVertexAttribArray,
    Sd: _emscripten_glEndQueryEXT,
    ...
    Kd: _emscripten_glGenQueriesEXT,
    Jd: _emscripten_glGenRenderbuffers,
    Id: _emscripten_glGenTextures,
    Hd: _emscripten_glGenVertexArraysOES,
    Gd: _emscripten_glGenerateMipmap,
    Fd: _emscripten_glGetActiveAttrib,
    Ed: _emscripten_glGetActiveUniform,
    Dd: _emscripten_glGetAttachedShaders,
    Cd: _emscripten_glGetAttribLocation,
    Bd: _emscripten_glGetBooleanv,
    Ad: _emscripten_glGetBufferParameteriv,
    zd: _emscripten_glGetError,
    yd: _emscripten_glGetFloatv,
    xd: _emscripten_glGetFramebufferAttachmentParameteriv,
    wd: _emscripten_glGetIntegerv,
    vd: _emscripten_glGetProgramInfoLog,
    ...
    qd: _emscripten_glGetQueryObjectuivEXT,
    pd: _emscripten_glGetQueryivEXT,
    od: _emscripten_glGetRenderbufferParameteriv,
    nd: _emscripten_glGetShaderInfoLog,
    md: _emscripten_glGetShaderPrecisionFormat,
    ld: _emscripten_glGetShaderSource,
    kd: _emscripten_glGetShaderiv,
    jd: _emscripten_glGetString,
    id: _emscripten_glGetTexParameterfv,
    hd: _emscripten_glGetTexParameteriv,
    gd: _emscripten_glGetUniformLocation,
    fd: _emscripten_glGetUniformfv,
    ed: _emscripten_glGetUniformiv,
    dd: _emscripten_glGetVertexAttribPointerv,
    cd: _emscripten_glGetVertexAttribfv,
    bd: _emscripten_glGetVertexAttribiv,
    ...
    Xc: _emscripten_glIsQueryEXT,
    Wc: _emscripten_glIsRenderbuffer,
    Vc: _emscripten_glIsShader,
    Uc: _emscripten_glIsTexture,
    Tc: _emscripten_glIsVertexArrayOES,
    Sc: _emscripten_glLineWidth,
    Rc: _emscripten_glLinkProgram,
    Qc: _emscripten_glPixelStorei,
    Pc: _emscripten_glPolygonOffset,
    Oc: _emscripten_glQueryCounterEXT,
    Nc: _emscripten_glReadPixels,
    Mc: _emscripten_glReleaseShaderCompiler,
    Lc: _emscripten_glRenderbufferStorage,
    Kc: _emscripten_glSampleCoverage,
    Jc: _emscripten_glScissor,
    Ic: _emscripten_glShaderBinary,
    Hc: _emscripten_glShaderSource,
    Gc: _emscripten_glStencilFunc,
    Fc: _emscripten_glStencilFuncSeparate,
    Ec: _emscripten_glStencilMask,
    Dc: _emscripten_glStencilMaskSeparate,
    Cc: _emscripten_glStencilOp,
    Bc: _emscripten_glStencilOpSeparate,
    Ac: _emscripten_glTexImage2D,
    zc: _emscripten_glTexParameterf,
    yc: _emscripten_glTexParameterfv,
    xc: _emscripten_glTexParameteri,
    wc: _emscripten_glTexParameteriv,
    ...
    ic: _emscripten_glUniform4f,
    hc: _emscripten_glUniform4fv,
    gc: _emscripten_glUniform4i,
    fc: _emscripten_glUniform4iv,
    ec: _emscripten_glUniformMatrix2fv,
    dc: _emscripten_glUniformMatrix3fv,
    cc: _emscripten_glUniformMatrix4fv,
    bc: _emscripten_glUseProgram,
    ac: _emscripten_glValidateProgram,
    $b: _emscripten_glVertexAttrib1f,
    _b: _emscripten_glVertexAttrib1fv,
    ...
    Vb: _emscripten_glVertexAttrib4f,
    Ub: _emscripten_glVertexAttrib4fv,
    Tb: _emscripten_glVertexAttribDivisorANGLE,
    Sb: _emscripten_glVertexAttribPointer,
    Rb: _emscripten_glViewport,
    k: _emscripten_longjmp,
    Qb: _emscripten_memcpy_big,
    Pb: _emscripten_pause_main_loop,
    ...
    Bb: _glDepthMask,
    Ab: _glDisable,
    zb: _glDisableVertexAttribArray,
    yb: _glDrawArrays,
    xb: _glDrawElements,
    wb: _glEnable,
    ...
    ma: _glGenBuffers,
    tb: _glGenFramebuffers,
    I: _glGenRenderbuffers,
    sb: _glGenTextures,
    rb: _glGetActiveUniform,
    qb: _glGetAttribLocation,
    c: _glGetError,
    U: _glGetIntegerv,
...
var _dmExportedSymbols = (Module["_dmExportedSymbols"] = function () {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = Module["asm"]["Ef"]).apply(null, arguments);
});
...
var _dmScript_Html5ReportOperationSuccess = (Module["_dmScript_Html5ReportOperationSuccess"] = function () {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = Module["asm"]["Jf"]).apply(null, arguments);
});
var ___errno_location = (Module["___errno_location"] = function () {
    return (___errno_location = Module["___errno_location"] = Module["asm"]["Kf"]).apply(null, arguments);
});
...
var _JSWriteDump = (Module["_JSWriteDump"] = function () {
    return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["Nf"]).apply(null, arguments);
});
var __get_tzname = (Module["__get_tzname"] = function () {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["Of"]).apply(null, arguments);
});
var __get_daylight = (Module["__get_daylight"] = function () {
    return (__get_daylight = Module["__get_daylight"] = Module["asm"]["Pf"]).apply(null, arguments);
});
var __get_timezone = (Module["__get_timezone"] = function () {
    return (__get_timezone = Module["__get_timezone"] = Module["asm"]["Qf"]).apply(null, arguments);
});
var stackSave = (Module["stackSave"] = function () {
    return (stackSave = Module["stackSave"] = Module["asm"]["Rf"]).apply(null, arguments);
});
var stackRestore = (Module["stackRestore"] = function () {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["Sf"]).apply(null, arguments);
});
var stackAlloc = (Module["stackAlloc"] = function () {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Tf"]).apply(null, arguments);
});
var _setThrew = (Module["_setThrew"] = function () {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["Uf"]).apply(null, arguments);
});
